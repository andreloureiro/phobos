...
var G__12725 = o;
(G__12725[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__12727__i < G__12727__a.length) {G__12727__a[G__12727__i] = arguments[G__12727__i + 0]; ++G__12727__i;}
  args = new cljs.core.IndexedSeq(G__12727__a,0);
} 
...
if(cljs.core.truth_((function (){var and__6528__auto__ = cljs.core.some_QMARK_(reagent.impl.template.find_dom_node);
if(and__6528__auto__){
var and__6528__auto____$1 = cljs.core.some_QMARK_(jsprops);
if(and__6528__auto____$1){
var and__6528__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__6528__auto____$2)){
...
var G__12733 = jsprops;
(G__12733["defaultValue"] = value);

(G__12733["onChange"] = ((function (G__12733,v,value,on_change){
return (function (p1__12731_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12731_SHARP_);
});})(G__12733,v,value,on_change))
);
...
var vec__12738 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12738,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12738,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12738,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___12741 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___12741 == null)){
} else {
var key_12742 = temp__4661__auto___12741;
(jsprops["key"] = key_12742);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12744 = (new reagent.impl.template.NativeWrapper());
(G__12744["name"] = c);
...
var G__12746 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12746) : reagent.impl.template.as_element.call(null,G__12746));
} else {
...
var len__7609__auto___12752 = arguments.length;
var i__7610__auto___12753 = (0);
while(true){
if((i__7610__auto___12753 < len__7609__auto___12752)){
args__7616__auto__.push((arguments[i__7610__auto___12753]));

var G__12754 = (i__7610__auto___12753 + (1));
i__7610__auto___12753 = G__12754;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7617__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12750){
var G__12751 = cljs.core.first(seq12750);
var seq12750__$1 = cljs.core.next(seq12750);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12751,seq12750__$1);
});
...
break;
default:
var G__12758 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12758;
continue;
...
var n__7454__auto___12759 = a.length;
var i_12760 = (0);
while(true){
if((i_12760 < n__7454__auto___12759)){
(a[i_12760] = reagent.impl.template.as_element((a[i_12760])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7454__auto___12762 = a.length;
var i_12763 = (0);
while(true){
if((i_12763 < n__7454__auto___12762)){
var val_12764 = (a[i_12763]);
if((cljs.core.vector_QMARK_(val_12764)) && ((reagent.impl.template.key_from_vec(val_12764) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12763] = reagent.impl.template.as_element(val_12764));
...
var ctx = {};
var vec__12767 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12767,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12767,(1),null);
...
var G__12769 = (cljs.core.count(argv) - first_child);
switch (G__12769) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12769){
